...
pub use papr_core::{
    ai, db, error, extraction, ingestion, models, opml, sanitize, sync, translate,
};
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::delete_tag,
            commands::list_tag_aliases,
            commands::create_tag_alias,
            commands::rename_tag_alias,
            commands::delete_tag_alias,
