...
# Unregister the papr-server launchd job: stop it and remove the LaunchAgent plist.
# Deployed binary, DB, frontend, and .env under DEPLOY_ROOT are left untouched.
#
